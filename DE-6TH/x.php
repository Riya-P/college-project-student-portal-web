...
<body style="background: linear-gradient(to right,white,#A0CBFF  )">
	...
	<div class="profnav" style="font-family: 'Times New Roman', Times, serif;background-color: #039BE5">
		<div class="up" >
			<i class="fa fa-user-circle" aria-hidden="true"><span style="color: #888888">Student</span></i>
			<div>
...
<!-- <?php if(isset($_SESSION['stu_id'])) : ?> -->
	<!-- <h1><u>Welcome</u></h1>
			 ...
			 <div class="textbox">
			 	<h3>Student Name: <?php echo $stu_name ;?></h3>
			 	<h3>Student Enrollment: <?php echo $stu_id ;?></h3>
			 </div> -->
<!-- <?php endif ?> -->
	<!-- </div> -->
	...
	<div id="report" class="profmain">
		<form method="post" action="form.php">
			...
			<!-- <input type="submit" value="Submit"  class="btn" style="width: 10%;" target="_blank"> -->
			<a href="form.php" target="_blank"><input type="submit"  value="Submit" name="submit" class="btn" style="width: 100px;"></a>
